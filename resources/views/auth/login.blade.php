      ...
      <div class="card-body">
          ...
          <div class="card-content p-2">
              ...
              <div class="text-center ">
                  ...
                  <h3 class="text-theme-color-2">{{ config('app.name', 'Laravel') }}</h3>
              </div>

              <div class="card-title text-uppercase text-center py-3 text-dark">{{ __('lang.signin') }}</div>
            @if (count($errors))
            ...
            @endif
              <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                  ...
                  <div class="form-group">
                      <label class="text-dark">{{ __('lang.phone') }}</label>
                  ...
                  <div class="form-group">
                      <label class="text-dark">{{ __('lang.password') }}</label>
                      <div class="position-relative has-icon-right">
                  ...
                  <div class="form-row align-items-center">
                      ...
                      <div class="form-group col-6">
                          <div class="icheck-material-primary">
                              ...
                              <label class="text-dark"for="user-checkbox">{{ __('lang.remember_me') }}</label>
                          </div>
                      </div>

                  </div>
                  <input type="submit" value="{{ __('lang.submit') }}" class="btn btn-dark btn-block btn-round m-1" />
              </form>   
